...
(function() {
    ...
    var OutlookUIIntegration = {
                ...
                '<div class="panel-content">' +
                    ...
                    '<div class="control-buttons">' +
                        ...
                        '<button class="btn btn-secondary" id="outlook-sync-btn" disabled>' +
                            ...
                            'Sync Calendar' +
                        '</button>' +
                        '<button class="btn btn-success" id="sync-outlook-events" disabled>' +
        ...
        updateConnectionStatus: function(isConnected) {
            var statusIndicator = document.getElementById('outlook-status-indicator');
            var statusText = document.getElementById('outlook-status-text');
            var connectBtn = document.getElementById('outlook-connect-btn');
            var disconnectBtn = document.getElementById('outlook-disconnect-btn');
            var syncBtn = document.getElementById('outlook-sync-btn');
            var syncEventsBtn = document.getElementById('sync-outlook-events');
