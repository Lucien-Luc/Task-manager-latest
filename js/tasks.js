...
window.taskManager = {
    ...
    updateTaskStatus: async function(taskId, newStatus) {
        try {
            ...
            // Two-way sync with Outlook if task is synced
            if (localTask && localTask.isOutlookSync && window.outlookSyncManager) {
                window.outlookSyncManager.updateOutlookEvent(localTask);
            }
